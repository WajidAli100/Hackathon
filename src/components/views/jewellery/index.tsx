      ...
      <div className="flex flex-col md:flex-row justify-between py-4 mt-2 gap-5">
        ...
        <div className="flex flex-col lg:flex-row basis-1/2">
          <div className="w-full px-4 lg:px-0 lg:w-80">
            <Image width={1000} height={1000} src={"https://commerece-e.vercel.app/_next/image?url=https%3A%2F%2Ffull-stack-ecommerce-clothing-web.vercel.app%2F_next%2Fimage%3Furl%3D%252F_next%252Fstatic%252Fmedia%252Ffeature.1118a2f3.png%26w%3D384%26q%3D75&w=1080&q=75"} alt={"Designer Jewellery"} />
          </div>
